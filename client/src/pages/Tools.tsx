    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="w-full max-w-6xl">
        <header className="mb-6">
          <h1 className="text-3xl md:text-4xl font-semibold text-slate-800">Tools</h1>
          <p className="text-slate-500 mt-1">Quickly access the tools you use most.</p>
        </header>
        ...
        <main>
          <div className="flex justify-between items-center mb-4">
            <p className="text-sm text-slate-500">Showing <strong>{filtered.length}</strong> tools</p>
            <div className="text-xs text-slate-400">Tip: click a tile to open a tool (hook up navigation where needed).</div>
          </div>
          ...
          {filtered.length === 0 && (
            <div className="mt-8 text-center text-slate-500">No tools match your search. Try different keywords.</div>
          )}
        </main>
